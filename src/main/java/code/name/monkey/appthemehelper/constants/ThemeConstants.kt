package code.name.monkey.appthemehelper.constants
...
object ThemeConstants {
    ...
    const val CUSTOM_LAUNCHER = "custom_launcher_key"
    const val LIBRARY_CATEGORIES = "library_categories"
    const val LANGUAGE_NAME = "language_name"
    const val CIRCLE_PLAY_BUTTON = "circle_play_button"
    const val PREF_REPORT_BUG_KEY = "pref_report_bug"

    const val PREF_DOCUMENTATION = "prefDocumentation"
    const val PREF_VIEW_FORUM = "prefViewForum"
    const val PREF_CHANGE_LOG = "pref_changelog"
    const val PREFERENCE_SYNC_ALL_DATA = "pref_synchronization_all_data_sync"

    const val THEME_AUTO_VALUE = "auto"
    ...
    const val WEBDEV_SERVER_URL = "webdev_server_url"
